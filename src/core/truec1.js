...
function processing (paramFx, paramMatrix, paramRB, paramFxType) {
  ...
  let res = ''
  res = '<div class="overflow-auto"><p class="text-lg font-semibold">Bài toán</p><hr class="my-4"><table class="table-auto w-full mb-5"><tr><td><strong>Dạng tổng quát</strong></td><td></td><td><strong>Dạng chính tắc</strong></td></tr><tr><td nowrap="nowrap"><strong><font color = "DodgerBlue">F(x):</font></strong>  '
  let cnt = 0
